...
INSERT INTO `community` VALUES (1,'test1','test descr',1,1,1,20.00,10.00,3.00,7.00,'');
...
INSERT INTO `currency` VALUES (1,'RE','Ruppe',2.00,''),(2,'DOL','Doller',10.00,'');
...
INSERT INTO `owner` VALUES (1,'test','test@test.com','1234',1,'5678','67878','2014-03-25 10:02:32','www.test.com','dfgdfgd','df','city','state','6005',1,'test','test','','city','state','6009',1);
...
INSERT INTO `entityoauthaccount` VALUES (1,'Supplier',2,1),(2,'CommunityOwner\"',1,1);
...
INSERT INTO `supplier` VALUES (2,'test','test@test.com','test.com','5678','','line1','line2','city','state','6009',1,'billing','address1','address2','city','state','6008',2,'12345',40.50,50.30,'2014-03-25 16:04:25','2014-03-25 16:04:25','quote',10.00,'deposite');
...
INSERT INTO `oauthaccount` VALUES (1,'test','test','test'),(3,'General','test@versatile-soft.com','test123'),(5,'General','test@test.com','test'),(9,'General','test2@test.com','test2'),(10,'General','','');
...
INSERT INTO `actions` VALUES (1,'test',1);
...
IN IN_BillingAddressPostalCode VARCHAR(50),
IN IN_BillingAddressCountryID VARCHAR(50),
IN IN_Longitude DECIMAL(10,2),
IN IN_Latitude DECIMAL(10,2),
...
-- ------------------------------------------------------------
    ...
    SELECT ReviewResponseID,ReviewID,Response,ResponseDate,HideResponse FROM ReviewResponse WHERE ReviewID=IN_ReviewID;
...
-- -------------------------------------------------------------
    ...
    SELECT CustomerID,CommunityID,PointsTally FROM CustomerPointsTally WHERE CustomerID=IN_CustomerID AND CommunityID=IN_CommunityID;
...
-- ----------------------------------------------------
    ...
    INSERT INTO Supplier(CompanyName,Email,Website,PrimaryPhone,OtherPhone,BillingName,BillingAddressLine1,BillingAddressLine2,BillingAddressCity
                         ,BillingAddressState,BillingAddressPostalCode,BillingAddressCountryID,BusinessNumber,Longitude,Latitude)
    VALUES(IN_CompanyName,IN_Email,IN_Website,IN_PrimaryPhone,IN_OtherPhone,IN_BillingName,IN_BillingAddressLine1,IN_BillingAddressLine2
            ,IN_BillingAddressCity,IN_BillingAddressState,IN_BillingAddressPostalCode,IN_BillingAddressCountryID,IN_BusinessNumber,IN_Longitude,IN_Latitude);
...
-- ----------------------------------------------------------
    ...
    IF(IN_Filter='All') THEN
        SELECT S.* FROM Supplier S LEFT JOIN CommunitySupplier CS ON CS.SupplierID=S.SupplierID 
...
-- -------------------------------------------------------------
    ...
    INSERT INTO Actions(Name,ActionResponse) VALUES(IN_ActionName,IN_ActionResponse);
    
    INSERT INTO TriggeredEvent(ActionID,RecVer,BillingPercentageAdministrator,BillingPercentageOwner,IsActive)
    VALUES(LAST_INSERT_ID(),1,IN_BillingPercentageAdministrator,IN_BillingPercentageOwner,IN_IsActive);
...
-- ------------------------------------------------------------
    ...
    START TRANSACTION;
        ...
        UPDATE Actions SET ActionResponse=IN_ActionResponse WHERE ActionId=IN_ActionId;
...
-- Dump completed on 2014-03-26 15:04:12
