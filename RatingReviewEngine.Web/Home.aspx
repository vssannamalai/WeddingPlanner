<%@ Page Title="" Language="C#" MasterPageFile="~/RatingReviewEngineLogin.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="RatingReviewEngine.Web.Home" %>

<%@ Register Src="~/UserControl/ucMenu.ascx" TagPrefix="uc1" TagName="ucMenu" %>

<asp:Content ID="contentHead" ContentPlaceHolderID="contentPlaceHolderHead" runat="server">
    <script src="js/slider/jssor.core.js"></script>
    <script src="js/slider/jssor.utils.js"></script>
...
<asp:Content ID="conttentBody" ContentPlaceHolderID="contentPlaceHolderBody" runat="server">
    ...
    <div id="slider1_container" style="position: relative; width: 1140px; height: 400px; overflow: hidden;">
        <!-- Loading Screen -->
        <div u="loading" style="position: absolute; top: 0px; left: 0px;">
            <div style="filter: alpha(opacity=70); opacity: 0.7; position: absolute; display: block; background-color: #000; top: 0px; left: 0px; width: 100%; height: 100%;">
            </div>
            <div style="position: absolute; display: block; background: url(../images/slider/loader.gif) no-repeat center center; top: 0px; left: 0px; width: 100%; height: 100%;">
            </div>
        </div>
        <!-- Slides Container -->
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1140px; height: 400px; overflow: hidden;">
            <div>
                <a u="image" href="#">
                    <img src="../images/slider/01.jpg" /></a>
                <div u="caption" t="*" class="captionOrange" style="position: absolute; left: 620px; top: 30px; width: 460px; height: 30px; text-align: left; padding-left: 10px;">
                    Need more customers for your small business?
                </div>
                <div u="caption" t="*" class="captionOrange" style="position: absolute; left: 620px; top: 65px; width: 460px; height: 60px; text-align: left; padding-left: 10px;">
                    Want to derive digital revenue from your existing customer base?
                </div>
                <div u="caption" t="*" class="captionOrange" style="position: absolute; left: 620px; top: 130px; width: 460px; height: 60px; text-align: left; padding-left: 10px;">
                    Want to set up global and multilingual communities to enrich your customer engagement?
                </div>
            </div>
            <div>
                <a u="image" href="#">
                    <img src="../images/slider/02.jpg" /></a>
                <div u="caption" t="*" class="captionOrange" style="position: absolute; left: 60px; top: 165px; width: 460px; height: 120px; text-align: left; padding-left: 10px;">
                    The Ratings and Reviews service by  Michael Hill enables businesses to set up and manage secure communities of small businesses who typically share the same customer base.
                </div>
                <div u="caption" t="*" class="captionOrange" style="position: absolute; left: 60px; top: 290px; width: 460px; height: 100px; text-align: left; padding-left: 10px;">
                    The resulting communities enable a superior service for customers and a greater volume of business for suppliers – Everybody benefits!
                </div>
            </div>
            <div>
                <a u="image" href="#">
                    <img src="../images/slider/03.jpg" /></a>
            </div>
            <div>
                <a u="image" href="#">
                    <img src="../images/slider/04.jpg" /></a>
                <div u="caption" t="*" class="captionOrange" style="position: absolute; left: 660px; top: 20px; width: 460px; height: 130px; text-align: left; padding-left: 10px;">
                    Create an account for free and log in to either join an existing community as a supplier or set up your own community for to manage suppliers you collaborate with.
                </div>
                <div u="caption" t="*" class="captionOrange" style="position: absolute; left: 350px; top: 200px; width: 200px; height: 30px; text-align: left; padding-left: 10px;">
                    <a href="Register.aspx" style="color: white; text-decoration: underline;">Click here to register</a>
                </div>
            </div>
            <div>
                <a u="image" href="#">
                    <img src="../images/slider/05.jpg" /></a>
                <div u="caption" t="*" class="captionOrange" style="position: absolute; left: 60px; top: 110px; width: 460px; height: 90px; text-align: left; padding-left: 10px;">
                    Suppliers in each community gain access to a larger pool of customers and get referrals for business.               
                </div>
                <div u="caption" t="*" class="captionOrange" style="position: absolute; left: 60px; top: 205px; width: 460px; height: 120px; text-align: left; padding-left: 10px;">
                    Customers can see suppliers in their area and read reviews from other customers to assist with their decision making with their privacy protected and secure.
                </div>
                <div u="caption" t="*" class="captionOrange" style="position: absolute; left: 60px; top: 330px; width: 460px; height: 60px; text-align: left; padding-left: 10px;">
                    Community owners earn a revenue from customer interactions with suppliers in their communities.
                </div>
            </div>
        </div>
        ...
        <style>
            ...
            */
            .jssora05l, .jssora05r, .jssora05ldn, .jssora05rdn {
                ...
                cursor: pointer;
                display: block;
                background: url(../images/slider/a06.png) no-repeat;
                overflow: hidden;
            }
        ...
        <!-- Arrow Left -->
        <span u="arrowleft" class="jssora05l" style="width: 40px; height: 40px; top: 178px; left: 8px;"></span>
        <!-- Arrow Right -->
        <span u="arrowright" class="jssora05r" style="width: 40px; height: 40px; top: 178px; right: 8px"></span>
