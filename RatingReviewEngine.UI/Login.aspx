...
<head runat="server">
    <title>MICHAEL HILL - Login</title>
    <!-- Loading Bootstrap -->
        ...
        <div class="container">
            <div class="row demo-row">
                ...
                <div class="col-xs-4">
                    ...
                    <div class="form-group">
                        <ul class="custom-login-ul-remove-bullets">
                            <li class="custom-login-li-button">
                                <%--<asp:Button ID="btnLogin" runat="server" Text="Log in" Style="height: 45px;" CssClass="btn btn-primary mrs" OnClientClick="Login()" />--%>
                                <input type="button" id="btnLogin" value="Log in" style="height: 45px;" class="btn btn-primary" onclick="Login()" />
                            </li>
                    ...
                    <asp:HiddenField ID="hdnAPIToken" runat="server" />
                </div>
