<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Login_RestAjaxCall.aspx.cs" Inherits="Login_RestAjaxCall" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>MICHAEL HILL - Login - Rest Ajax Call</title>
    <!-- Loading Bootstrap -->
    ...
    <script type="text/javascript">
        ...
        function UserLogin() {
            ...
            $.ajax({
                type: "POST",
                url: "http://localhost:19406/RatingReviewEngineAPI.svc/Login/" + Provider + "/" + ProviderUserID + "/" + Token,                
