<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Login_RestServiceAsObject.aspx.cs" Inherits="Login_RestServiceAsObject" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>MICHAEL HILL - Login - Rest Service As Object</title>
    <!-- Loading Bootstrap -->
    ...
    <script type="text/javascript">
        ...
        function UserLogin() {
            ...
            var ProviderUserID = $("#txtEmail").val();
            var Token = $("#txtPassword").val();

            $.ajax({
                type: "POST",
                url: "http://localhost:19406/RatingReviewEngineAPI.svc/UserLogin",
                data: '{"Provider": "' + Provider + '", "ProviderUserID": "' + ProviderUserID + '", "Token": "' + Token + '"}',
            ...
            <div class="row demo-row">
                ...
                <div class="col-xs-4">
                    ...
                    <div class="form-group" id="passwordDiv" runat="server">
                        ...
                        <span id="spanValidationMessage" style="display: none; font-size:15px; font-weight:normal; line-height:2.4; color:#E74C3C;">The email or password you entered is incorrect. </span>
                    </div>
                    ...
                    <div class="form-group">
                        <ul class="custom-login-ul-remove-bullets">
                            <li class="custom-login-li-button">
                                <%--<asp:Button ID="btnLogin" runat="server" Text="Log in" Style="height: 45px;" CssClass="btn btn-primary mrs" OnClientClick="UserLogin()" />--%>
                                <input type="button" id="btnLogin" value="Log in" style="height: 45px;" class="btn btn-primary mrs" onclick="UserLogin()" />
                            </li>
